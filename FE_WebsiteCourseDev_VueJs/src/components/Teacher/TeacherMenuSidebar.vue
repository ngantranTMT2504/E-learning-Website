...
const menuConfig = [
  ...
  },
  {
    ...
    children: [
      { label: "Danh sách khoá học", to: "/teacher/course/list" },
      { label: "Danh sách bài học", to: "/teacher/lesson/list" },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      { label: "Doanh Thu Tháng", to: "#" },
      { label: "Khoá Học", to: "/teacher/statistical/course" },
    ],
  },
  {
...
.slide-enter-to,
.slide-leave-from {
  max-height: 500px; /* có thể tăng tuỳ chiều submenu */
  opacity: 1;
}
